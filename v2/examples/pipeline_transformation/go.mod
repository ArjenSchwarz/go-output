module github.com/ArjenSchwarz/go-output/v2/examples/pipeline_transformation

go 1.24.3

toolchain go1.24.5

replace github.com/ArjenSchwarz/go-output/v2 => ../..

require github.com/ArjenSchwarz/go-output/v2 v2.0.0-00010101000000-000000000000
